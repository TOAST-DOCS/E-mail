...
* [Console]ドメイン登録有効性ロジックを改善
    * ドメイン登録時のドメイン有効性検査ロジックが改善されました。
    * ドメインに一部記号('．', '。', '．', '｡')が含まれる場合、ドメイン登録ができません。

* [API]メール送信リクエスト時のドメイン有効性検査を改善
    * メール送信リクエスト時のドメイン有効性検査ロジックが改善されました。
    * ドメインに一部記号('．', '。', '．', '｡')が含まれる場合、メール送信リクエストができません。
