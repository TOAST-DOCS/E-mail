...
## Notification > Email > API v2.1ガイド { #notification-email-api-v21-guide }
...
### メール送信アップデート完了一覧の照会 { #view-the-list-of-completed-email-delivery-updates }
...
### 大量メールリスト照会 { #query-mass-delivery-list }
...
### 大量メール送信受信者照会 { #query-recipient-for-mass-delivery }
...
### 大量メール送信詳細照会 { #query-mass-delivery-details }
...
### 統計照会 { #statistics-query-statistics }
...
| extra1s        | Array String | X   | eventCategoryがMESSAGEの場合、メールタイプでフィルタリング可能。 NORMAL, MASS, SMTP                               |
...
### 統計合計照会 { #query-statistical-totals }
