...
## Notification > Email > API v1.5ガイド { #notification-email-api-v15-guide }
...
|title|	String|	O|	メールのタイトル（最大 998 文字）|
|body|	String|	O|	メールの内容|
|attachFileIdList|	List:Integer|	X|	アップロードした添付ファイルid（ファイルアップロード時にfile idを返却）|
...
|title|	String|	O|	メールのタイトル（最大 998 文字）|
|body|	String|	O|	メールの内容|
|attachFileIdList|	List:Integer|	X|	アップロードした添付ファイルid（ファイルアップロード時に file id を返却）|
|templateId|	String|	X|	送信テンプレートID（最大 50 文字）|
