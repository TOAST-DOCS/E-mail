...
* [Console] 도메인 등록 유효성 로직 개선
    * 도메인 등록 시 도메인 유효성 검사 로직이 개선되었습니다.
    * 도메인에 일부 기호('．', '。', '．', '｡')가 포함될 경우 도메인 등록이 불가능합니다.

* [API] 메일 발송 요청 시 도메인 유효성 검사 개선
    * 메일 발송 요청 시 도메인 유효성 검사 로직이 개선되었습니다.
    * 도메인에 일부 기호('．', '。', '．', '｡')가 포함될 경우 메일 발송 요청이 불가능합니다.
