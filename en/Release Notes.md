...
* [Console] 광고성 메일 발송 기능 추가
    ...
    * 자세항 사항은 [<a href="/en/Notification/E-mail/en/Getting%20Started/#_3" target="_blank">광고성 메일발송</a>] [<a href="/en/Notification/E-mail/en/Getting%20Started/#_9" target="_blank">수신 거부 관리</a>]를 참고해주세요.
* [API] 광고성 메일 발송 기능 추가
...
* [API] 수신거부 관리 기능 추가
    ...
    * 자세항 사항은 [<a href="/en/Notification/E-mail/en/Developer%60s%20Guide/#_36" target="_blank">수신 거부 관리</a>]를 참고해주세요.
* [API] 통합 통계 조회 기능 추가
...
* [Console]통계 화면 개선
    ...
    * 자세항 사항은 [<a href="/en/Notification/E-mail/en/Developer%60s%20Guide/#_35" target="_blank">통합 통계 조회</a>]를 참고해주세요.
...
* [API] 수신자명 지원
    * API에서도 수신자명 필드가 추가되었습니다. 자세한 사항은 [<a href="/en/Notification/E-mail/en/Developer%60s%20Guide/#_2" target="_blank">메일 발송 문서</a>]를 참고해주세요.
* [Console] 통계 화면 제공
    * 일별/월별 통계 화면이 제공됩니다.
    * 통계 정보는 2017년 4월 1일부터 수집됩니다.
* [API] 통계 조회 기능 제공
    * 일별/월별 통계 조회 API가 제공됩니다. 자세한 사항은 [<a href="/en/Notification/E-mail/en/Developer%60s%20Guide/#_31" target="_blank">통계 조회 문서</a>]를 참고해주세요.
...
* [API] 메일발송 상세조회 API의 Response 필드 추가 (<a href="/en/Notification/E-mail/en/Developer%60s%20Guide/#_20" target="_blank">문서링크</a>)
