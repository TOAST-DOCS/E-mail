...
* [Console] 태그 메일 발송 내역 조회 화면 추가
    ...
    * 자세한 내용은 [[태그 메일 발송 조회 탭](./console-guide/#_8)]를 참고해주세요.
* [Console] 태그, UID 관리 기능 추가
    * 태그 메일 발송에 사용되는 태그와 UID에 대한 생성, 수정, 삭제 기능을 제공합니다.
    * 자세한 내용은 [[태그 관리](./console-guide/#_10)], [[UID 관리](./console-guide/#uid)]를 참고해주세요.
* [API] 태그 메일 발송, 조회 기능 추가
    * 태그 메일을 발송하고 조회할 수 있는 API를 제공합니다.
    * 자세한 내용은 [[태그 메일발송](./api-guide/#_10)]를 참고해주세요.
* [API] 태그, UID 관리 기능 추가
    * 태그 메일 발송에 사용되는 태그와 UID를 생성, 수정, 삭제할 수 있는 API를 제공합니다.
    * 자세한 내용은 [[태그 관리](./api-guide/#_44)], [[UID 관리](./api-guide/#uid)]를 참고해주세요.
