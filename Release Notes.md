...
### 2017.2.23
#### 기능 추가
* [Console][API] 이메일 수신확인 기능 추가
    * [Console] 메일 요청별 조회 -> 메일 상세 조회 화면에서 수신 확인 여부 표시
    * [API] 메일발송 상세조회에서 수신여부, 수신날짜 필드 추가

#### 기능 개선/변경
* [Console][API] 메일 발송 수신자 수 제한
    * 하나의 요청에 발송 가능한 수신자 수 1000명으로 제한
    * 수신자, 참조자 구분 없음.
* [Console][API] 첨부파일 업로드 및 발송 용량 제한
    * 업로드 가능한 최대 첨부파일 용량 : 10MB
    * 메일 발송 시 최대 첨부파일 용량 : 10MB(파일 총 합)   
