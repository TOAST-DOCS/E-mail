...
- 발송 도메인의 SPF, DKIM, DMARC 인증을 완료하고 본 가이드의 정책을 준수했음에도 발송 지연이 지속된다면, [고객 센터 > 1:1 문의](https://www.nhncloud.com/kr/support/inquiry)를 통해 발송 내역 확인을 요청해 주십시오.
- 도메인 인증 상태와 발송 내역을 확인한 뒤 결과를 안내해 드립니다.
