...
**첨부 파일**: 메일에 첨부 파일을 추가합니다.
    ...
    - 첨부 파일은 최대 3개까지 업로드 가능하며, 10MB 이하의 파일만 가능합니다.
        - 첨부 파일의 총합은 10MB를 넘어갈 수 없습니다.
...
- **확인 후 진행**: 수신자별 메일 주소와 발송 내용을 **태그 메일 발송 조회** 탭에서 확인 후 메일 발송을 진행할 수 있습니다. 사용자가 발송을 진행하지 않으면 메일이 발송되지 않으니 유의해 주세요.
