...
TOAST는 정보통신망법을 준수할 수 있도록, '광고 메일'에 아래와 같은 기술적 조치를 제공합니다.
* 제목에 (광고) 문구를 삽입합니다.
...
이에, '당사'에서는 '고객'이 TOAST Email 서비스를 이용함에 있어 관련 법령을 준수하고, 위탁 현황 미공개로 인하여 과태료 등의 불이익을 받지 않도록 아래와 같이 가이드할 수 있습니다.
