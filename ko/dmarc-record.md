...
## Notification > Email > 도메인 관리 가이드 > DMARC { #notification-email-domain-management-guide-dmarc }

<a id="what-is-dmarc-domain-based-message-authentication-reporting-and-conformance"></a>
### DMARC (domain-based message authentication reporting and conformance)란? { #what-is-dmarc-domain-based-message-authentication-reporting-and-conformance }
...
### DMARC DNS 레코드 구조 { #record-structure-of-dmarc-dns }
...
### 실패 보고서 생성 기준 (fo)에 대한 값 설명 { #description-of-values-for-criteria-fo-of-failure-report-generation }
...
### DMARC 레코드 검증 절차 { #dmarc-record-certification-procedure }
