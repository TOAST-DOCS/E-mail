...
### 2020. 12. 29.
#### 기능 추가
* [Console] 대량 메일 발송 프로세스 개선
    * 대량 메일 발송 프로세스가 개선되었습니다.
        * 수신자 파일 업로드 시 유효하지 않은 수신자가 포함된 경우 아래 두 목록 파일에 대한 다운로드를 제공합니다.
            * 유효한 수신자 메일 주소 목록 다운로드
            * 유효하지 않은 수신자 메일 주소 목록 다운로드
        * 유효한 수신자에게만 메일 발송을 원하는 경우 [유효한 수신자만 메일 발송] 버튼을 클릭하여 발송할 수 있습니다.
