...
* [Console] 발송 내역 export 시 "읽음 여부" 필드 추가
    * 일반 발송 내역 export 결과에 "읽음 여부" 필드 추가
    * 수신자의 메일 열람 상태를 더 쉽게 확인하고 분석할 수 있게 되었습니다.
    * 기존 export 기능에서 제공되지 않았던 읽음 여부 정보를 통해 메일 발송 효과를 보다 정확하게 측정할 수 있습니다.
...
* [SMTP] 서브도메인 검증 로직 개선
    ...
    * 서브도메인 사용 고객의 메일 발송 안정성이 향상되었습니다.
