...
* [API] 일반, 광고 메일 발송 API 응답 변경
  ...
  * 자세한 내용은 [[일반 메일 발송 API 응답](./api-guide/#_4)]과 [[개별 메일 발송 API 응답](./api-guide/#_7)]을 참고해주세요.
* [API] 통계 조회 API에 광고 여부 조건 추가
  * 광고 메일과 광고가 아닌 메일을 구분하여 통계를 확인할 수 있습니다.
  * 자세한 내용은 [[통합 통계 조회 API](./api-guide/#_83)]을 참고해주세요.
...
* [API] 인증 메일 발송 API 추가
  ...
  * 자세한 내용은 [[인증 메일 발송 API](./api-guide/#_11)]를 참고해주세요.
...
* [API] 첨부 파일을 재사용할 수 있도록 구조 변경
  ...
  * [[첨부 파일 업로드 API v1.2](./api-guide/#_14)]를 사용하여 업로드한 첨부 파일은 v1.2 발송 API 사용하여 메일을 발송 시 첨부 파일을 재사용할 수 있습니다.
  * Toast Email에서 제공하는 모든 발송 API v1.2에서 사용할 수 있습니다.
  * 버전이 업데이트된 API는 [[API 가이드](./api-guide/)]의 각각 API 명세를 참고해주세요.
* [API] 메일 주소 유효성 검사 강화
...
* [API] 사용자 지정 헤더 기능 추가
  ...
  * 버전이 업데이트된 API는 [[메일 발송 상세 조회](./api-guide/#_26)]와 [[태그 메일 발송 상세 조회](./api-guide/#_35)]를 참고해주세요.
* [API] 숨은 참조 기능 추가
...
* [API] 태그 메일 발송, 조회 기능 추가
  ...
  * 자세한 내용은 [[태그 메일발송](./api-guide/#_11)]를 참고해주세요.
* [API] 태그, UID 관리 기능 추가
  * 태그 메일 발송에 사용되는 태그와 UID를 생성, 수정, 삭제할 수 있는 API를 제공합니다.
  * 자세한 내용은 [[태그 관리](./api-guide/#_45)], [[UID 관리](./api-guide/#uid)]를 참고해주세요.
