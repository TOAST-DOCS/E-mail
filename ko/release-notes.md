...
* [Console] 태그 메일 발송 기능 추가
    * 태그를 사용한 메일 발송이 가능합니다.
    * 태그 메일 발송을 위한 기능을 아래와 같이 제공합니다.
        * 태그를 사용하여 수신자를 등록할 수 있는 기능 제공
        * 태그를 사용하여 발송한 메일을 조회할 수 있는 화면 제공
        * (참조) TOAST Documents > Email > 콘솔 사용 가이드 > 태그를 사용한 메일발송
                TOAST Documents > Email > 콘솔 사용 가이드 > 태그 메일 발송 조회 탭
* [API] 태그 메일 발송 기능 추가
    * 태그를 사용한 메일 발송의 경우 별도로 제공되는 API를 사용할 수 있습니다.
    * 태그 메일 발송을 위한 기능을 아래와 같이 제공합니다.
        * 태그를 사용하여 메일을 발송할 수 있는 API 제공
        * 태그를 사용하여 발송한 메일을 조회할 수 있는 API 제공
